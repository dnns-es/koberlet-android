...
| DCA con kb-ETH, FLUX y bro (`free.ksw-dca3`, siempre contra KDA) | **Sí (2.13.0, sin publicar)** | **Falta** | **Falta** | KDA↔kb-USDC sigue en `ksw-dca2`; los tres nuevos van al dca3, que lo elige main por el par. La gasolinera **no** paga dca3 (solo admite dca2/ksw2): el gas lo pone el usuario. Mínimos por compra: 0,0004 kb-ETH, 15 FLUX, 0,0002 bro. Los planes se leen de los dos contratos. |
| Gasolinera en el DCA | Sí | **Cable sin conectar** | **Falta** | El Kotlin ya lo acepta (`FirmaKda.kt:335`), pero la pantalla no lo manda (`pantalla-dca.js:554`). |
